  ...
  return (
    <div className="flex flex-col justify-center items-center md:items-start gap-7 xl:flex-1">
      ...
      <p className="text-justify text-lg leading-7 px-2 md:px-0">
        ...
        6-month course and hold a degree in Computer Science Engineering.
      </p>
      ...
      <div className=" grid lg:grid-cols-1 xl:grid-cols-2 gap-5 h-[400px] md:h-[200px]  overflow-y-auto lg:hover:overflow-y-auto px-3 lg:overflow-y-hidden scrolling">
        <div className="flex flex-col justify-center items-center shadow-md shadow-black  bg-neutral-900 text-[#C73659] py-4 px-3 my-2 w-[full]  h-[170px] gap-3">
