...
const About = () => {
  return (
    <div className=" text-white h-screen md:flex justify-center flex-col">
      <div className="flex flex-col justify-center items-center mt-28 m-10">
        <h1 className="font-bold text-2xl">About</h1>
        <p className=" font-normal text-lg">My Introduction</p>
      </div>
      <div className=" flex flex-col gap-5 justify-between md:items-center md:flex-row md:mt-4 max-w-[1224px] mx-auto px-4">
