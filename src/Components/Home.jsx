...
const Home = () => {
  return (
    <>
      <div className=" bg-white h-[100vh] text-black py-32 md:py-24  lg:py-44 xl:py-48 container mx-auto flex flex-col justify-center gap-10 lg:flex-row md:items-center ">
        {/* Left side content */}
